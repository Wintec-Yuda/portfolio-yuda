...
export default function Home() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-gray-100">
			{/* Navigation */}
			<header
				className={`fixed w-full z-50 transition-all duration-300 bg-gray-900/60 backdrop-blur-md ${
						...
						<div className="max-w-4xl mx-auto">
								...
								<div className="bg-gray-800/70 rounded-xl p-6 border border-gray-700 shadow-lg">
									<div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4">
										<h4 className="text-xl font-medium text-white">
											{t.experience.aiMastery.title}
										</h4>
										<span className="text-gray-400 text-sm md:text-base">
											{t.experience.aiMastery.period}
										</span>
									</div>
									<p className="text-blue-300 mb-3">
										{t.experience.aiMastery.company}
									</p>
							...
							>
								...
								<div className="bg-gray-800/70 rounded-xl p-6 border border-gray-700 shadow-lg">
									<div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4">
										<h4 className="text-xl font-medium text-white">
											{t.experience.kalbe.title}
										</h4>
										<span className="text-gray-400 text-sm md:text-base">
											{t.experience.kalbe.period}
										</span>
									</div>
									<p className="text-blue-300 mb-3">
										{t.experience.kalbe.company}
									</p>
									<ul className="space-y-2 text-gray-300 mb-4">
							...
							>
								...
								<div className="bg-gray-800/70 rounded-xl p-6 border border-gray-700 shadow-lg">
									<div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4">
										<h4 className="text-xl font-medium text-white">
											{t.experience.kasihInovasi.title}
										</h4>
										<span className="text-gray-400 text-sm md:text-base">
											{t.experience.kasihInovasi.period}
										</span>
									</div>
									<p className="text-blue-300 mb-3">
										{t.experience.kasihInovasi.company}
									</p>
									<ul className="space-y-2 text-gray-300 mb-4">
